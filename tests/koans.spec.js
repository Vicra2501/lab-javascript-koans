describe('the JavaScript language', () => {
  describe('has different types and operators', () => {
    ...
    it('surprises me, NaN is not comparable with NaN', () => {
      // COMMENT: dont really get the question here
    ...
    // COMMENT: no matter if i use truthy or falsy. npm shows failed
    ...
    it('knows the type of a function', () => {
      // COMMENT: Again unclear instruction
      function x() {
        //false
      }

      expect(typeof x).toBe('function');
      expect(typeof(x)).toBe('comment');
    });
...
//???
      expect(arr[2](1)).toEqual(function(arg){});
    });
    ...
    it('joins arrays and other things', () => {
      const a = [1, 2, 3];
      const b = ['x', 'y', 'z'];
// COMMENT: put in the results that RunJS would give me
     expect(1 + a).toEqual('11,2,3');
      expect(a + 1).toEqual('1,2,31');
